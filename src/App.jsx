...
import p26 from './assets/images/26.jpg'
...
function App() {
  ...
  return (
    ...
    <p>Turban</p>
    <Parallax pages={27}>
    <ParallaxLayer offset={0} speed={v+=0.5}
    style={{
            backgroundImage: `url(${p1})`,
            backgroundRepeat:"repeat-x, true",
            backgroundSize: 'contain',
          }} >
             <p>©️2022 Designs by Breitner, Lanesteppers™️.</p>
             <p>Engineering by Jerry Ochieng.</p>
             <p>Created for the visuals.</p>
            <p>So glad that you could make it...</p>
        </ParallaxLayer>
    
        <ParallaxLayer offset={o+=1}  speed={1}  factor={(Math.random()*3)+1}
    style={{
 ...
 <ParallaxLayer offset={o+=1}  speed={v+=0.5}  factor={(Math.random()*3)+1}
    style={{
